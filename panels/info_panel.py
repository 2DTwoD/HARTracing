...
class InfoPanel(QWidget, Updater):
    def __init__(self):
        ...
        self.devTypeMonitor = MonitorLine("Код модели датчика:")
        ...
        grid.addWidget(self.devTypeMonitor.getLabelWidget(), row, 2)
        grid.addWidget(self.devTypeMonitor.getValueWidget(), row, 3)
    ...
    def updateAction(self):
        ...
        self.devTypeMonitor.setValue(self.comDict.get("devType"))
